<template>
	<div class="comPreview">
		...
		<div class="detailHeader clearfix">
			<div class="createrImg" :style="{background:getlogoUrl(7.4,3.5,userInfos.headImg)}"></div>
			<div class="createByName text-ell">{{userInfos.nickName || "少花点"}}</div>
			<div class="createDate">{{getLocalTime2(new Date() / 1000)}}</div>
		</div>
