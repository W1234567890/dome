		...
		<div class="slidesClassMain" ref='slidesClassMain'>
			<div v-scrollt>
				...
				<div class="footer">
					...
					<span>您已成功邀请<span class="amount">{{friendList}}</span>位好友，获得奖励<span class="totalSum">{{data.money}}</span>元</span>
				</div>
...
export default {
	...
	methods: {
		shareToFriend(){
		 	...
		 	this.share({url:"http://testapph5.pengjipay.com:8088/#/linkRegister"});
		},	
		init(){	 
