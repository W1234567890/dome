	...
	<div class="relaseActivity" :class="!getActivityOrder && 'bgbai'">
		<div>
				...
				<div class="contentBox">
					...
					<div class="footerItem">
						<p class="protocol">
							...
							<span class="xieyi"  @click="ischecked=!ischecked">《微米商城服务协议》</span>
						</p>
				...
				<div class="choseAddItem">
					<div class="swiper-container" id="swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide" v-for="(vo,key) in DataArr" :key="key" @click="addData(vo.rest)">
			...
			<div class="lineWrap" v-if="lineListShow">
				 <ul class="lineList">
				 	<li class="lineItem" v-for="(vo,key) in lineData" :key="key" @click="addData('line',vo)">
	...
	export default {
		data() {
			return {
				...
				lineData:[
					{line:require('src/assets/img/line/line1.gif'),lineId:111111},
	                {line:require('src/assets/img/line/line2.gif'),lineId:111112},
	                {line:require('src/assets/img/line/line3.gif'),lineId:111113},
	                {line:require('src/assets/img/line/line4.jpg'),lineId:111114},
	                {line:require('src/assets/img/line/line5.gif'),lineId:111115},
	                {line:require('src/assets/img/line/line6.gif'),lineId:111116},
	                {line:require('src/assets/img/line/line7.gif'),lineId:111117},
	                {line:require('src/assets/img/line/line8.gif'),lineId:111118}
	            ],//分割线集合
	            DataArr : [
	            ...
	            tips: [
					...
					{name: "ischecked",content: "请同意微米商城服务协议"}
				],
		...
		methods: {
			...
			uploads(img,isPost){
				let /*url = "http://supply.weimishanghao.com/a/rest/activity/publish",*/
