export default {
	...
	scrollt:{
		...
		bind: function(el, binding, vnode) {
			...
			configimg = "http://xiaoshijie.oss-cn-shenzhen.aliyuncs.com/poster/1500195830396.png",
			_vendor = (function () {
		    ...
		    function createDefaultScrollbar() {
		      ...
		      scrollbar.style.cssText += ';width:.14rem;bottom:.04rem;top:.04rem;right:.02rem';
		      scrollbar.style.cssText += ';overflow:hidden';
		
		      indicator.style.cssText = '-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;background:rgba(179,179,179,0.8);border:1px solid rgba(255,255,255,0.9);border-radius:.09rem;';
		    ...
		    function createDefaultTopTips() {
		    	if(typeof vnode.context.ResetTop == "function"){
					let topDomMain = document.createElement('div'),
						...
						topDomLabel.style.cssText += ';position: absolute;top: 0;left: -.3rem;font-size: .3rem;display: inline-block;';
		    ...
		    function createScrollTop(){
		    	let scrollTop = document.createElement('div'),
		    		...
		    		scrollTop.style.cssText = "position: fixed;bottom: 1.5rem;width: .68rem;height:.68rem;line-height: .68rem;right: .4rem;font-size: .65rem;color: rgba(153,153,153,.6);text-align: center;background-color:transparent;border-radius: 100%;";
