        ...
        ************   Views   ************
        ...
        var View = function (selector, params) {
            ...
            view.handleTouchStart = function (e) {
                ...
                watchPage = typeof window.watchPage == 'function' && Math.abs(window.watchPage()) || 0;
                let dom = document.getElementsByClassName('page-on-left');
                for(var i=0;i<dom.length;i++){
                		if(dom[i].querySelectorAll('.iswiper').length > 0){
                			watchPage = 0;
                		}
                }
            };
            ...
            view.handleTouchMove = function (e) {
                ...
                if (app.device.pixelRatio === 1) {
        			...
        			/*if(window.scrollToMove || window.iswiperToMove){
        				activePageTranslate = .1;
		        		//return;
		        }*/
